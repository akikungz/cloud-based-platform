...
export const PendingRequest: React.FC<PendingRequestProps> = ({ limit = 10 }) => {
  ...
  useEffect(() => {
    const fetchRequests = async () => {
      ...
      const simulatedRequests: PendingRequestItemProps[] = Array.from({ length: limit }, (_, index) => ({
        id: `request-${index + 1}`,
...
export const PendingRequestItem: React.FC<PendingRequestItemProps> = ({ title, description, requestedBy, course, spec }) => {
  return (
