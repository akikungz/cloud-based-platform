/** biome-ignore-all lint/complexity/noBannedTypes: type definition file requires complex types */
/** biome-ignore-all lint/style/useImportType: type definition file requires runtime imports */
...
export declare const app: Elysia<
	...
	{
		typebox: {
			Import: <Key extends never>(
				key: Key,
				options?: import("@sinclair/typebox").SchemaOptions,
			) => import("@sinclair/typebox").TImport<{}, Key>;
		};
		error: {};
	},
	{
			...
			readonly auth: {
				readonly resolve: ({
					...
					>(
						code: Code,
						response?: T,
					) => import("elysia/dist/error").ElysiaCustomStatusResponse<
						Code,
						T,
						Code extends
							| "Continue"
					...
					get: {
						...
						response: {
							200: {
								...
								readonly role: import("utils").Role;
							};
							500: {
