...
export interface InstanceArgs<Path extends PVE_PATH, Method extends keyof PVE_API<Path>> {
	path: Path;
	method: Method;
...
>({ path, method, params, body }: InstanceArgs<Path, Method>): Promise<InstanceReturn<Response>> => {
