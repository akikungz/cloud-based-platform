...
export type PVE_Empty_Response = {
	data: string;
};
...
export type PVE_API<Path extends keyof PVE_API_Template> =
	PVE_API_Template[Path];

export type PVE_RequestBody<
	Path extends keyof PVE_API_Template,
	Method extends keyof PVE_API_Template[Path],
> = PVE_API_Template[Path][Method] extends RequestOptions<
	any,
	any,
	infer B,
	any
...
export type PVE_RequestResponse<
	Path extends keyof PVE_API_Template,
	Method extends keyof PVE_API_Template[Path],
> = PVE_API_Template[Path][Method] extends RequestOptions<
	any,
