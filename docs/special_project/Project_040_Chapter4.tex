...
\adjustbox{frame, width=1.0\textwidth}{
    \includegraphics[width=1.0\textwidth]{Image/web/system_architecture.png}
}
...
\centering
\adjustbox{frame, width=0.9\textwidth}{
    \includegraphics[width=0.9\textwidth]{Image/web/dashboard/student/requests.jpeg}
}
...
\begin{figure}[htbp]
\centering
\adjustbox{frame, width=0.7\textwidth}{
    \includegraphics[width=0.7\textwidth]{Image/web/dashboard/staff/dashboard.jpeg}
}
...
\centering
\adjustbox{frame, width=0.9\textwidth}{
    \includegraphics[width=0.9\textwidth]{Image/web/dashboard/staff/semesters.jpeg}
}
...
\centering
\adjustbox{frame, width=0.9\textwidth}{
    \includegraphics[width=0.9\textwidth]{Image/web/dashboard/staff/staff_management.jpeg}
}
...
\hspace*{1.5em}
ทำการทดสอบสมรรถนะของ \textbf{Midori} (Frontend/Next.js) โดยมีเป้าหมายการทดสอบคือ \url{http://localhost:3000} ระยะเวลารวม 20 วินาที และระดับความขนานต่อเส้นทาง 20
